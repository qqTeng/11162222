...
$(function(){
	...
	*/
	function showMsg(msg,uuid){
		...
		top.$('context-msg').style.display = "block";
		top.$('context-msg-text').innerHTML = msg;
		top.$('hid-action').value = "dep_delete.action?de.uuid="+uuid;
	}
</script>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="123">&nbsp;</td>
						<td width="62">部门名称:</td>
						<td width="142"><s:textfield name="dqe.name" size="18"/></td>
						<td width="60">电话:</td>
						<td width="149"><s:textfield name="dqe.tele" size="18"/></td>
								...
								<td>
									...
									<span style="line-height:12px; text-align:center;"> 
										<s:a action="dep_input" cssClass="xiu">
											<s:param name="de.uuid" value="uuid"/>
											修改
										</s:a>
									</span> 
